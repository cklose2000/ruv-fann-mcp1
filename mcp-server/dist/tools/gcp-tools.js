...
export const BIGQUERY_TOOLS = GCP_TOOLS.filter(tool => tool.name.startsWith('gcp-sql') || tool.name.startsWith('bq-'));
export const STORAGE_TOOLS = GCP_TOOLS.filter(tool => tool.name.startsWith('gcs-'));
...
export function convertToolNameFromBackend(toolName) {
    return toolName.replace(/_/g, '-');
}
export const GCP_TOOL_COUNT = GCP_TOOLS.length;
//# sourceMappingURL=gcp-tools.js.map